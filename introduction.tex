...
New isotopes can be products of different reaction types.
\begin{itemize}
	\item 
...
Since the lifetime of the desired exotic system is extremely small, the properties of interest are usually reconstructed from its decay products by one of widely used methods.
\begin{itemize}
	\item 
...
This thesis is devoted to studies of light neutron-rich exotic nuclear systems, synthesized at ACCULINNA-2 fragment separator.
