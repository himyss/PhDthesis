...
This is clearly seen in works \cite{Aoyama:2004,Aoyama:2009} where the same approach provided $E_{T} \approx 7$ and $E_{T} \approx 4$\,MeV, in works \cite{Aoyama:2004} and \cite{Aoyama:2009} respectively.
